...
const ChatIncomingText = props => {
  return (
    <div className="CoxChatTextBoxIncoming">
      <p className="CoxChatTextIncomingText" align="left">{props.message}</p>
    </div>
  );
}
...
const ChatOutgoingText = props => {
  return (
    <div className="CoxChatTextBoxOutgoing">
      <p className="CoxChatTextOutgoingText" align="left">{props.message}</p>
    </div>
  );
}
